...
public class MapParserTest {
    ...
    public void unrecongizedMap(){
        mapParser = new MapParser(levelFactory,boardFactory);        when(boardFactory.createGround()).thenReturn(mock(Square.class));
        ...
        assertThatThrownBy(()-> {
            ...
            .hasMessage("this resource can not be recongized "+file);
    }
